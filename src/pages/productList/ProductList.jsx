...
const ProductList = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 items-center justify-center px-4 m-auto pt-10">
        {filteredProducts.length > 0 ? (
          filteredProducts.map((product) => (
            <div
              className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm  h-full transition transform hover:scale-105 hover:shadow-xl"
              key={product.id}
            >
              <img
