            ...
            <main className={`fixed inset-0 flex justify-center items-center 
                ...
                <div className="p-8 w-11/12 h-[auto] bg-gray-50 rounded-md
                    ...
                    <div className="flex flex-col items-center mb-4 text-center">
                        ...
                        <img src={message ? "/modal-check.png" : "/modal-error.png"} className="mb-4 w-24"/>

                        <img src={message ? "//modal-check.png" : "/modal-error.png"} alt="" className="mb-4 w-24"/>

                        {message ? 
                            (<div className="text-[#555] font-medium">
                                <p className="text-5xl leading-normal mb-2">
                                    Message sent!
                                </p>
                                <p className="text-xl">
                    ...
                    <button 
                        onClick={closeModal} 
                        className="bg-[#db4444] text-[#fafafa] w-40 h-[50px]
                        text-md rounded font-medium justify-self-end hover:bg-[#db0000] 
                        hover:text-[#fafafa] m-4 cursor-pointer">
                        OK
                    </button>
                </div>
            </main>
