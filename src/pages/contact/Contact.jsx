...
export default function Contact() {
  ...
  function SendEmail(e) {
    ...
    emailjs
      .sendForm("service_mey8v6n", "template_yie6xer", formElement.current, {
  ...
  return (
    <>
      {modal && (
        <ContactModal modal={modal} message={message} closeModal={closeModal} />
      )}
      ...
      <main
        className="flex justify-center items-center xl:flex-row xl:mt-0 mt-16 
                px-2 lg:px-8 xl:px-24"
      >
        <div
          className="flex flex-col gap-y-4 xl:flex-row xl:gap-8 justify-center
                    items-center"
        >
          <section
            className="flex flex-col w-[100%] h-[auto] xl:w-[50%] xl:h-[457px] 
          ...
          >
            ...
            <div
              className="max-w-full md:max-w-full h-[1px] bg-gray-500
                            opacity-50 my-8"
            ></div>
            <div
              className="flex items-center space-x-2
            ...
            <div
              className="max-w-full md:max-w-full h-[1px] bg-gray-400
                            opacity-50 mt-8 xl:hidden"
            ></div>
          </section>
          <section
            className="w-[100%] h-[auto] xl:h-[457px] xl:py-14 xl:px-9 
          ...
          >
            ...
            <form onSubmit={SendEmail} ref={formElement}>
              <div className="grid grid-cols-3 grid-rows-5 gap-x-4 gap-y-6 relative">
                <input
                  className="xl:col-span-1 xl:row-span-1 col-span-3 
                ...
                {/* <input className="sm:col-span-1 sm:row-span-1 col-span-3 
                                ...
                                /> */}
                <textarea
                  className="col-span-3 row-span-3 bg-gray-200 
                ...
                ></textarea>
                <button
                  className="xl:col-start-3 xl:col-end-4 col-span-3 
